    ...
    return (
        <div id="privacy-policy">
            ...
            <div className="container">
                <h1 className="pb-1">Privacy Policy</h1>
                <p className="pb-4">Last updated: July 06, 2022</p>
                ...
                <h1 className="pb-1">Interpretation and Definitions</h1>
                <h2 className="pb-3">Interpretation</h2>
                <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                <h2 className="pb-1 pt-2">Definitions</h2>
                <p>For the purposes of this Privacy Policy:</p>
                <ul>
                    <li>
                        <p><strong>Account</strong> means a unique account created for You to access my Service or parts of my Service.</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;I&quot;, &quot;Me&quot; or &quot;My&quot; in this Agreement) refers to alvarodev-lc.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to alvarodev-lc, accessible from <a href="http://alvarodev-lc.com" target="_blank" rel="noreferrer">http://alvarodev-lc.com</a></p>
                    </li>
                    <li>
                        <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                    </li>
                </ul>
                <h1 className="pb-2 pt-3">Collecting and Using Your Personal Data</h1>
                <h2 className="pb-2">Types of Data Collected</h2>
                <h3 className="pb-3">Personal Data</h3>
                ...
                <h3 className="pb-2 pt-2">Usage Data</h3>
                ...
                <h3 className="pb-1 pt-3">Tracking Technologies and Cookies</h3>
                ...
                <h2 className="pb-1 pt-3">Use of Your Personal Data</h2>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>For business transfers:</strong> I may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of My assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Me about my Service users is among the assets transferred.</p>
                    </li>
                    <li>
                        <p><strong>For other purposes</strong>: I may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of my promotional campaigns and to evaluate and improve my Service, products, services, marketing and your experience.</p>
                    </li>
                </ul>
                ...
                <h2 className="pb-2 pt-3">Retention of Your Personal Data</h2>
                ...
                <h2 className="pb-2 pt-3">Transfer of Your Personal Data</h2>
                ...
                <h2 className="pb-1 pt-3">Disclosure of Your Personal Data</h2>
                <h3 className="pb-1">Business Transactions</h3>
                ...
                <h3 className="pb-1 pt-2">Law enforcement</h3>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                <h3 className="pb-1 pt-2">Other legal requirements</h3>
                ...
                <h2 className="pb-1 pt-2">Security of Your Personal Data</h2>
                ...
                <h2 className="pb-1 pt-3">Children's Privacy</h2>
                ...
                <h2 className="pb-1 pt-3">Links to Other Websites</h2>
                ...
                <h2 className="pb-1 pt-3">Changes to this Privacy Policy</h2>
                ...
                <h2 className="pb-1 pt-3">Contact Me</h2>
                <p>If you have any questions about this Privacy Policy, You can contact me:</p>
                <ul>
                    <li>
                        <p>By email: alvaro.lopez19997@gmail.com</p>
                    </li>
                    <li>
                        <p>By phone number: 603623143</p>
                    </li>
                </ul>
            </div>
        <Footer/>
